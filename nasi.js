...
const vcard = 'BEGIN:VCARD\n' //jangan ganti eror jngn nyesel
            ...
            + 'FN:AMINGANTENG\n' //ganti aja 
            + 'ORG: AMINBotZ;\n' //ganti aja
            + 'TEL;type=CELL;type=VOICE;waid=6288227248988:+6288227248988\n'  //ganti nomor lu
...
const ownerNumber = ["6285230628605@s.whatsapp.net"]   //ganti nomor lu
//###########
...
//=============== BATES COK ===================//
		...
		case 'help': 
		case 'menu':
            costum(`*Suport AminBot dengan cara follow https://instagram.com/asroriamin123*`, text, tescuk, ari)
            if (!isRegistered) return reply( ind.noregis())
...
│• Prefix : ${prefix}
│
│• YouTube : ARI BAGUS WIDYANTORO
│• Instagram : https://Instragram/ari__bagus
│• FaceBook : abwsidsad
│• github : https://github.com/Abwhost123
│• Nomor Owner : wa.me/6288227248988
╰────
...
break
		...
		case 'lpr':
					...
					client.sendMessage('6288227248988@s.whatsapp.net', options, text, {quoted: mek})
...
client.sendMessage(from, Mau, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
		...
		if (budy.includes(`6288227248988`)) {
